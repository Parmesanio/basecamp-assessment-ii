...
var myFriends = ['Taylor', 'Felicia', 'Marilyn', 'Mike'];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push('Chase');

// #7 Create a 'myArrayCopy' variable. It should equal the myArray variable. Use the built in JavaScript method to create a copy.
//DON'T TOUCH THE CODE BELOW
var myArray = [1, 2, 3, 4];
//DON'T TOUCH THE CODE ABOVE
var myArrayCopy = myArray.map(function(i) {
  return i;
});
...
function evensOnly() {
  ...
  myNumbers.forEach(function(n) {
    n%2 == 0 ? evensArray.push(n) : console.log('Odd');
  });
  return evensArray;
}
...
var indexes = [];
randomNumbers.filter(function(val, i , arr) {
  indexes.push(i);
});
